...
%------------------------------------------------------------------------
%Se llaman losarchivos que contienen los capítulos del libro.
\part{FIRST PART}
% r.9 introduction
\subfile{Capitulos/introduccion.tex}
%Agrega una página en blanco después del capítulo
\newpage
...
\begin{figure*}[p]
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/vdqi-title.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/ei-title.pdf}}
\\\vspace{\baselineskip}
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/ve-title.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/be-title.pdf}}
\end{figure*}
...
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/vdqi-contents.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/ei-contents.pdf}}
\\\vspace{\baselineskip}
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/ve-contents.pdf}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{Imagenes/be-contents.pdf}}
\end{figure*}
...
\begin{marginfigure}%
  \includegraphics[width=\linewidth]{Imagenes/helix}
...
\begin{figure*}[h]
  \includegraphics[width=\linewidth]{Imagenes/sine.pdf}%
...
\begin{figure}
  \includegraphics{Imagenes/hilbertcurves.pdf}
